      ...
      if (strNombre == "" || strApellido == "") {
        ...
        request.onreadystatechange = function () {
            if (request.readyState == 4 && request.status == 200) {
                ...
                if (objData == "guardado") {
                    Swal.fire("Enhorabuena","Datos guardados satisfactoriamente","success");
                }else if(objData.includes("Connection error")){
                    Swal.fire("Error","Hay un error del lado del servidor, pronto se solucionará, perdone el inconveniente","error");
