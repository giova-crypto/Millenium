...
<head>
    ...
    <!-- Hojas de estilo personalizadas, de bootstrap y CDN de JQuery-->
...
<body>
    <!-- Formulario para el frontend con clases de bootstrap -->
    <hr>
    <div class="d-flex justify-content-center align-items-center container-data">
        <div class="formulario">
            <form id="formUsuario" name="formUsuario" class="form-horizontal">
                <h1>Formulario <i class="bi bi-clipboard-data"></i></h1>
                ...
                <br>
                <button id="guardar" type="submit" class="btn btn-primary"><i class="bi bi-upload"></i>&nbsp;&nbsp;Guardar datos</button>
            </form>
        </div>
    </div>
    <!-- Archivos JS necesarios para usar las alertas personalizadas, bootstrap y el código del programa -->
    <script src="//cdn.jsdelivr.net/npm/sweetalert2@11"></script>
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.0.1/dist/js/bootstrap.bundle.min.js" integrity="sha384-gtEjrD/SeCtmISkJkNUaaKMoLD0//ElJ19smozuHV6z3Iehds+3Ulb9Bn9Plx0x4" crossorigin="anonymous"></script>
    <script src="index.js"></script>
</body>
<!-- Pie de página con mis datos de contacto -->
